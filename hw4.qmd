...
#	if pd.isna(dfclean["ZIP CODE"].iloc[index]) == False:
#		zr = search.by_zipcode(dfclean["ZIP CODE"].iloc[index])
#		if zr is None:
#			continue
#		dfclean.at[index, "POPULATION"] = zr.population
#		dfclean.at[index, "HOUSE UNIT"] = zr.housing_units
